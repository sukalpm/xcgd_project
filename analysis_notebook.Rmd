...
```{r}
source("src/globals.R", local = knitr::knit_global())
```
...
```{r}
source("src/integration.R", local = knitr::knit_global())
```
...
```{r}
source("src/diff_exp.R", local = knitr::knit_global())
```
...
```{r}
source("src/coexp.R", local = knitr::knit_global())
```
